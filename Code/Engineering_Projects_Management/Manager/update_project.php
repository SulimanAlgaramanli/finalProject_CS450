...
$contract_sign_date = isset($_POST['contract_sign_date']) && $_POST['contract_sign_date'] !== '' ? $_POST['contract_sign_date'] : null;
...
$project_start_date = isset($_POST['ProjectStartDate']) && $_POST['ProjectStartDate'] !== '' ? $_POST['ProjectStartDate'] : null;
$project_end_date = isset($_POST['ProjectEndDate']) && $_POST['ProjectEndDate'] !== '' ? $_POST['ProjectEndDate'] : null;
...
$stmt->bind_param("iissiiiissiisii", $customer_id, $supervising_engineer_id, $contract_sign_date, $land_location, $is_in_plan, $has_building_permit, $property_type, $land_area, $project_start_date, $project_end_date, $project_status, $progress_percentage, $property_description, $rate_of_cost_plus, $project_id);
$stmt->execute();
...
if ($stmt->affected_rows > 0) {
    ...
    //echo "<script>alert('لم يتم تحديث المشروع');</script>";
    header("Location: Projects_Table.php");
