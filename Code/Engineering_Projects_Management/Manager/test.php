...
<head>
    ...
    <title>بيانات فواتير المواد</title>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>    
                                                <div class=\"action-buttons\">
                                                    <form class='botton_table' method='GET' action='edit_invoice.php' style='display: inline-block;'>
                                                    ...
                                                    <form class='botton_table' method='POST' action='delete_invoice.php'>
                                                        <input type='hidden' name='invoice_id' value='" . $row["invoice_id"] . "'>
